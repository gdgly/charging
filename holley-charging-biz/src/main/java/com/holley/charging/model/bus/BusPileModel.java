...
public class BusPileModel {
    ...
    public String getIsIntelligentDesc() {
        if (isIntelligent == null) return "";
        String desc = WhetherEnum.getText(isIntelligent.intValue());
    ...
    public String getChaTypeDesc() {
        if (chaType == null) return "";
        String desc = ChargePowerTypeEnum.getText(chaType.intValue());
        return desc == null ? "" : desc;
    }

    public String getStandardDesc() {
        if (standard == null) return "";
        String desc = ChargeInterfaceTypeEnum.getText(standard.intValue());
        return desc == null ? "" : desc;
    }

    public String getStatusDesc() {
        if (status == null) return "";
        String desc = PileModelStatusEnum.getText(status.intValue());
        return desc == null ? "" : desc;
    }
