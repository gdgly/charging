   ...
   <div id="badChargeListDiv" class="hide">
    <form class="form-inline" role="form">
     <div class="form-group pull-right">
			...
			<button type="button" id="goBackBadListPageBtn" class="btn btn-primary">返回</button>
		 </div>
    </form>
    	...
    	<div class="form-group">
    	 <label class="col-sm-2 control-label"><span style="color: red;">*</span>卡密码</label>
	      ...
	      <div class="col-sm-offset-2 col-sm-10">
	         ...
	         <button id="cancelRechargeBtn" type="button" class="btn btn-primary">返回</button>
	      </div>
   		</div>
   		</form>
  </div>
  <div id="CardInfoDiv">
  	...
  	<h5>用户基本信息</h5>
		<div class="form-group">
	      ...
	      <div class="col-sm-4">
	      	<input type="text" class="form-control" id="realName" name="realName" maxlength="10" disabled="disabled" placeholder="请读取卡信息"/>
	      </div>
    	...
    	<div class="form-group">
			<label class="col-sm-2 control-label"><span style="color: red;">*</span>手机号码</label>
		        <div class="col-sm-4">
		      		<input type="text" class="form-control" id="phone" name="phone" maxlength="20" disabled="disabled" placeholder="请读取卡信息"/>
		        </div>
		    <label class="col-sm-2 control-label"><span style="color: red;">*</span>邮箱地址</label>
		        <div class="col-sm-4">
		        	<input type="text" class="form-control" id="email" name="email" maxlength="20" disabled="disabled" placeholder="请读取卡信息"/>
		        </div>
    	</div>
    	<div class="form-group">
	        ...
	        <div class="col-sm-4">
	      		<input type="text" class="form-control" id="userCardNo" name="userCardNo" maxlength="20" disabled="disabled" placeholder="请读取卡信息"/>
	        </div>
    	</div>
    	</form>
    	<hr/>
    	...
    	<div class="form-group">
	        ...
	        <div class="col-sm-4">
	      		<input type="text" class="form-control" id="busNo" name="busNo" maxlength="20" disabled="disabled" placeholder="请读取卡信息"/>
	        </div>
    	...
    	<div class="form-group">
	        ...
	        <div class="col-sm-4">
	        	<div class='input-group date' id='startTimeDate'>
							<input id="startTime" name="startTime" type='text' class="form-control" disabled="disabled" placeholder="请读取卡信息"/> 
							<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span> </span>
				</div>
	        </div>
	       	<label class="col-sm-2 control-label"><span style="color: red;">*</span>卡内余额(元)</label>
	        <div class="col-sm-2">
	        	<input type="text" class="form-control"  id="usableMoney" maxlength="20" disabled="disabled" placeholder="请读取卡信息"/>
	        </div>
    	...
    	<div class="form-group">
    	  <label class="col-sm-2 control-label"><span style="color: red;">*</span>有效日期</label>
	        <div class="col-sm-4">
	        	<div class='input-group date' id='endTimeDate'>
						<input id="endTime" name="endTime" type='text' class="form-control" disabled="disabled" placeholder="请读取卡信息"/> 
						<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span> </span>
				</div>
	        </div>
	 	...
	 	<!-- 	<label class="col-sm-2 control-label"><span style="color: red;">*</span>灰色记录</label>
	        <div class="col-sm-3">
	        	<input type="text" id="badChargeIds" class="form-control" maxlength="20" disabled="disabled" placeholder="灰色记录"/>
	        </div>
	        <div class="col-sm-1">
    	...
    	<div class="form-group">
	      <div class="col-sm-offset-2 col-sm-10">
	         ...
	         <button id="goChangePwdBtn" type="button" class="btn btn-primary" disabled="disabled">卡密码修改</button>
	          <button id="checkBadRcordBtn" type="button" class="btn btn-primary" disabled="disabled">查看灰色记录</button>
...
<!--     模态框（Modal）badPaymentModal -->
					...
					<form role="form" id="badPaymentForm">
		              <div class="box-body">
		               <div class="form-group hide">
		                  <label for="badrecordIdModel">灰ID</label>
		                  <p type="text" class="form-control" id="badrecordIdModel" ></p>
		                </div>
		                <div class="form-group">
		                ...
		                <div class="form-group">
		                  <label for="freezeModel">冻结金额</label>
		                  <p type="text" class="form-control" id="freezeModel" ></p>
		                </div>
		                <div class="form-group">
		                  	<label>密码</label>
		                  	<input type="password" class="form-control"  id="badPaymentPwd" maxlength="6"/>
		                	</p>
		                </div>
		              </div>
		             <!--  /.box-body -->
	...
	<!--   模态框（Modal）readBadRecordModal -->
	<div class="modal fade" id="readBadRecordModal" tabindex="-1" role="dialog"
		aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="myModalLabel">读灰记录</h4>
				</div>
				<div class="modal-body">
					<form role="form" id="readBadRecordForm">
		              <div class="box-body">
		                <div class="form-group">
		                 	<label>充电卡号</label>
			                <p style="color: #00c0ef;font-size: 20px;" id="cardNoForReadBadRecord"></p>
		                </div>
		               	<div class="form-group">
		                  	<label>密码</label>
		                  	<input type="password" class="form-control"  id="readBadRecordPwd" maxlength="6"/>
		                	</p>
		                </div>
		              </div>
		             <!--  /.box-body -->
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
					<button id="readBadRecordBtn" type="button" class="btn btn-primary">提交</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
...
<script type="text/javascript">
	...
	//CODEBASE="${webroot}/res/ocx/HLChargeCard.cab#version=1,0,0,1"
</script>
