	...
	<!--main-->
		...
		<!-- 	<div class="row">
			...
			<form class="form-horizontal" role="form" id="stationForm"
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="stationName"
							placeholder="充电站名称" name="stationName" value="" maxlength="30"/>
					</div>
				...
				<div class="form-group">
					<label for="addStationImg" class="col-sm-2 control-label hide">图片上传：</label>
					<div class="col-sm-4 hide">
							<img id="showAddStationImg" alt="Image preview" class="img-thumbnail" style="height: 20%; width: 50%;cursor: pointer;" src="${imgUrl}data/stationImg/stationDefault.jpg" /> 
							<input type="file" name="img" id="addStationImg" class="hide"/>
					</div>
					<label for="linkPhone" class="col-sm-2 control-label"><span
...
$("#showAddStationImg").on("click",function(){
	$("#addStationImg").click();
});
...
$(function(){
	...
	var station;
	var param = {};
	var addStationByAjaxUrl = "device/station_addStationByAjax.action";
	var addPileUrl = "device/addPile.action";
...
/* 	$("#finishBtn").on("click",function(){
	...
	$("#addPileBtn").on("click",function(){
		if(newStationId > 0){
		href(addPileUrl+"?stationId="+newStationId);
		}else{
			showWarning("当前无法添加！！");
		}
	});
