...
<body>
 	...
 	<div>
	    <form class="form-inline" role="form">
		    <div class="form-group">
			     ...
			     <input id="stationName" type="text" class="form-control" placeholder="请输入充电站名称"/>
 	...
 	<div>
	    <form class="form-inline" role="form">
		    <div class="form-group">
			     ...
			     <input id="pileName" type="text" class="form-control" placeholder="请输入充电桩名称"/>
  ...
  <script src="res/js/device/deviceVerifyList.js" type="text/javascript"></script>
</body>
</html>
