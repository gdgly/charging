	...
	<h5>电费规则</h5>
					...
					<div id="chargeFeeDiv">
						...
						<div class="col-sm-4">
							...
							value='<s:property value="#request.unActiveRule.chargeFee"/>' placeholder="保留小数点后4位"/>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input maxlength="10" type="text" class="form-control" id="parkFee"
							name="parkFee"
							value='<s:property value="#request.unActiveRule.parkFee"/>' placeholder="保留小数点后4位"/>
					</div>
					...
					<div class="col-sm-4">
						<input maxlength="10" type="text" class="form-control" id="serviceFee"
							name="serviceFee"
							value='<s:property value="#request.unActiveRule.serviceFee"/>' placeholder="保留小数点后4位"/>
					</div>
				</div>
				<div class="form-group">
