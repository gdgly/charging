  		...
  		<s:if test="#request.activeRule != null">
	    	...
	    	<div class="form-group">
		      ...
		      <s:if test="#request.activeRule.chargeruleId == 1">
			      ...
			      <div class="col-sm-4">
			      	<p class="form-control-static"><s:property value="#request.activeRule.chargeFee"/>&nbsp;
	    	...
	    	<div class="form-group">
		      <label class="col-sm-2 control-label">费用启用时间</label>
		      <div class="col-sm-4">
    	...
    	<s:if test="#request.unactiveRule != null">
	    	...
	    	<div class="form-group">
		      ...
		      <s:if test="#request.unactiveRule.chargeruleId == 1">
		      	 <label class="col-sm-2 control-label">单一电费金额</label>
			      <div class="col-sm-4">
			      	<p class="form-control-static"><s:property value="#request.unactiveRule.chargeFee"/>&nbsp;
			      	<s:if test="#request.stationToType == 1">
			      	元/度
			      	</s:if>
			      	<s:elseif test="#request.stationToType == 2">
