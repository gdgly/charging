...
<body>
  ...
  <div class="container">
    	...
    	<div class="form-group">
	      ...
	      <div class="col-sm-4">
	      	<p class="form-control-static">
	      		<s:property value="#request.chargeStation.provinceDesc"/>
	      		<s:if test="#request.chargeStation.provinceDesc != '' && #request.chargeStation.cityDesc != ''">&nbsp;,&nbsp;</s:if>
	      		<s:property value="#request.chargeStation.cityDesc"/>
	      	</p>
	      </div>
    ...
    <div class="form-group">
    	 <label class="col-sm-2 control-label">站类型</label>
	      <div class="col-sm-4">
	      	<p class="form-control-static"><s:property value="#request.chargeStation.stationToTypeDesc"/></p>
	      </div>
    	...
    	<div class="form-group">
	      ...
	      <label class="col-sm-2 control-label">所属子公司</label>
	      <div class="col-sm-4">
	      	<p class="form-control-static"><s:property value="#request.chargeStation.busMecName"/></p>
	      </div>
    	...
    	<div class="form-group">
	      <label class="col-sm-2 control-label hide">图片</label>
	    ...
	    <s:else>
	      <img class="img-thumbnail img-thumbnail-size" alt="" src="${imgUrl}data/stationImg/stationDefault.jpg" onmouseenter="openImg(this,'充电站')" onmouseleave="closeImg(this)"/>
