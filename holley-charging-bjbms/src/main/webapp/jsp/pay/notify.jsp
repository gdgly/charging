<%@page import="com.holley.platform.model.sys.SysOperationLog"%>
...
<%
	...
	*验证通知 处理自己的业务
	*/
	String key = "1IkrtRNqQFbLIQfdMeJ6gIUs8NQq0HA3"; //记得更改 http://codepay.fateqq.com 后台可设置
	...
	if(mySign.equals(sign)){ 
	 ...
	 System.out.println(request.getParameter("pay_no"));
		out.print("success");
	}else{
		//参数不合法
		out.print("fail");
