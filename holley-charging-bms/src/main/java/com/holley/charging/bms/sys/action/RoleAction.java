...
public class RoleAction extends BaseAction {
     ...
     */
    public String init() {
        RoleTypeEnum[] roleTypeList = RoleTypeEnum.values();
    ...
    public String queryList() throws Exception {
        ...
        if (StringUtil.isNotEmpty(roletype) && !"0".equals(roletype)) {
            params.put("type", Short.valueOf(roletype));
        }
    ...
    private Map<String, Object> validRoleInfo(String jsonObj) {
        ...
        if (StringUtil.isEmpty(sysRole.getRolename())) {
            ...
            msg = "角色类型不能为空.";
        } else if (sysRole.getStatus() == null) {
            msg = "角色状态不能为空.";
        }
    ...
    public String loadPermission() {
        ...
        Short systemid;
        if (RoleTypeEnum.PLATFORM == roleType) {
