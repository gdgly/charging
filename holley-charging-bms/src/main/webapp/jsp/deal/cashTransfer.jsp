...
<body>
  ...
  <div class="container">
     <form class="form-horizontal" role="form">
		...
		<div class="form-group">
	      <label class="col-sm-2 control-label"><span style="color: red;">*</span>提现结果</label>
		  <div class="col-sm-4">
			<select id="cashStatus" name="cashStatus" class="form-control" onchange="onStatusChange()">
		     	<s:iterator value="#request.cashStatusList" var="item" status="st">
		     		<s:if test="#request.cashStatus == #item.value">
		...
		<div id="validRemarkDiv" class="form-group hide">
			<label class="col-sm-2 control-label"><span style="color: red;">*</span>提现失败原因</label>
		    <div class="col-sm-4">
  ...
  <script src="res/js/deal/cashTransfer.js" type="text/javascript"></script>
