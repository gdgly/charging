...
<body>
  ...
  <!--main-content-->
  <div class="container">
    <form id="conditionFrom" class="form-inline" role="form" action="deal/cashVerify_queryCashList.action">
	    <div class="form-group">
			 ...
			 <input id="fileName" name="fileName" value="提现审核记录" type="hidden">
		</div>
  ...
  <script src="res/js/deal/cashVerifyList.js" type="text/javascript"></script>
</body>
</html>
