...
<body>
  ...
  <div class="container">
    ...
    <div id="stationResult">
	    <form id="sconditionFrom" class="form-inline" role="form" action="run/monitor_queryStationList.action">
		    <div class="form-group">
				<input id="keyword" name="keyword" type="text" class="form-control" placeholder="请输入充电点名称/地址/运营商名称" style="width: 280px;"/>
			 ...
			 <div class="form-group pull-right">
				<button type="button" id="queryStationBtn" class="btn btn-primary">查询</button>
				<button type="button" id="exportStationBtn" class="btn btn-primary">导出</button>
			 </div>
	    </form>
	    <!-- 表格 -->
    ...
    <div id="pileResult" class="hide">
	    ...
	    <form id="pconditionFrom" class="form-inline" role="form" style="padding-left: 20px;padding-top: 10px;" action="run/monitor_queryPileList.action">
		    <div class="form-group">
			 ...
			 <div class="form-group pull-right">
				<button type="button" id="queryPileBtn" class="btn btn-primary">查询</button>
				<button type="button" id="exportPileBtn" class="btn btn-primary">导出</button>
			 </div>
	    </form>
    ...
    <div id="pileDetailResult" class="hide">
	    ...
	    style="cursor:pointer;font-weight: bold;font-size: 16px;"></span>
	    <div class="form-group pull-right">
			<button type="button" id="refreshPileStatusBtn" class="btn btn-primary">刷新</button>
	    </div>
