...
//        			 html += '<td class="text-right">'+item.recordId+'</td>';
        			 ...
        			 html += '<td class="text-right">'+item.operateMoneyDesc+'</td>';
        			 html += '<td class="text-right">'+item.totalMoneyDesc+'</td>';
        			 html += '<td class="text-right">'+item.usableMoneyDesc+'</td>';
        			 html += '<td class="text-right">'+item.freezeMoneyDesc+'</td>';
...
function queryRecoreDetail(type,recordid,usertype){
	...
	}else if(ACCOUNTLOG_TYPE_ACC_CHARGING == type || ACCOUNTLOG_TYPE_UNACC_CHARGING == type){//平台账户充电 或 非平台账户充电
