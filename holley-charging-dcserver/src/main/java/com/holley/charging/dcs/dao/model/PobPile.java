...
public class PobPile {
    ...
    public String getZHComAddr() {
        if (!StringUtil.isEmpty(comAddr) && (!StringUtil.isEmpty(comSubAddr))) {
            String tempStr = comAddr + StringUtil.AddjustLength(comSubAddr, 2, "0");
            return tempStr;
        }
        return comAddr;
    }
