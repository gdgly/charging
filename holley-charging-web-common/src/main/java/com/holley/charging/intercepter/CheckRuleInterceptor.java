...
public class CheckRuleInterceptor extends BaseInterceptor {

    private static final long   serialVersionUID = 1008901298342362080L;
    private static final Logger logger           = Logger.getLogger(CheckRuleInterceptor.class);
    ...
    public String intercept(ActionInvocation invocation) throws Exception {
        ...
        if (webUser.getRealStatus() == RealVerifyStatusEnum.PASSED.getShortValue()) {
            ...
            getRequest().setAttribute("backUrl", "bussiness/realName.action");
