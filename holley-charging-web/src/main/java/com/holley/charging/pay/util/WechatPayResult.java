...
public class WechatPayResult {
    ...
    private String total_fee;     // 订单总金额，单位为分;1元=100分；
    private String fee_type;      // 货币种类，符合ISO4217标准的三位字母代码，默认人民币：CNY
    private String cash_fee;      // 实际支付：现金支付金额订单现金支付金额
    private String cash_fee_type; // 货币类型，符合ISO4217标准的三位字母代码，默认人民币：CNY
    private String coupon_fee;    // 优惠券总金额：代金券或立减优惠金额<=订单总金额，订单总金额-代金券或立减优惠金额=现金支付金额
    private String coupon_count;  // 优惠券的数量：1张
    private String coupon_id_0;   // 代金券或立减优惠ID,$n为下标，从0开始编号;目前一个订单只能用一张优惠券，(后面需要延伸的话，加参数)
    private String coupon_fee_0;  // 单个代金券或立减优惠支付金额,$n为下标，从0开始编号
