 ...
 * @author sc
 */
public class UserChargingAction extends BaseAction {

    private final static Logger logger = Logger.getLogger(UserChargingAction.class);
    private Page                page;

    public String searchCharges() throws Exception {
        return SUCCESS;
    }
