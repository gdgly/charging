...
<body>
	...
	<div class="bg" style="height: 950px;">
		<!--main-content-->
		<div class="container main-body" style="height: 92%;" id="addPileDiv">
			<div class="row">
				<div class="col-sm-3">
					<h3>新增桩设备信息</h3>
				</div>
				...
				<div class="col-sm-offset-6 col-sm-3 text-right"
					...
					<button disabled="disabled" id="nextPileBtn" type="button" class="btn btn-warning btn-sm">继续添加</button>
					<button id="finishBtn" type="button" class="btn btn-warning btn-sm">完成</button>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="pileName"
							name="pileName" maxlength="30" placeholder="电桩名称"/>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="pileCode"
							name="pileCode" maxlength="30" placeholder="电桩编号"/>
					</div>
					...
					<div class="col-sm-4">
						...
						<div class='input-group date' id='oneTimeDate'>
							<input id="buildTime" name="buildTime" type='text' class="form-control" placeholder="电桩安装时间"/> 
		...
		<label for="comAddr" class="col-sm-2 control-label"><span
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="comAddr"
							name="comAddr" maxlength="30" placeholder="电桩通讯地址"/>
					</div>
		</div>
		<div class="form-group">
			<label for="comType" class="col-sm-2 control-label"><span
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="chargeFee"
							name="chargeFee" placeholder="保留小数点后2位" maxlength="10"/>
					</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="parkFee"
							name="parkFee" placeholder="保留小数点后2位" maxlength="10"/>
					</div>
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="serviceFee"
							name="serviceFee" placeholder="保留小数点后2位" maxlength="10"/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-4">
							...
							<input id="activeTime" name="activeTime" type='text' placeholder="电费规则启用时间"
