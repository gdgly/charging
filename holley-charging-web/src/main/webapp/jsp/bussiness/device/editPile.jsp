...
<body>
	<!--main-->
	<div class="bg" style="height: 980px;">
		<!--main-content-->
		<div class="container main-body" style="height: 92%;" id="editPileDiv">
			<div class="row">
				<div class="col-sm-3">
					<h3>修改桩设备信息</h3>
				</div>
				<div class="col-sm-offset-7 col-sm-2 text-right"
					...
					<!--  <button id="backBtn" type="button" class="btn btn-success">返回</button> -->
	...
	<s:if test="#request.actionType == 'editNewStationPile'">
				<div class="form-group">
					...
					<label for="chargeFee" class="col-sm-2 control-label"><span
						style="color: red;">*</span>单一电费(元)：</label>
					<div class="col-sm-4">
						<input maxlength="10" type="text" class="form-control" id="chargeFee" name="chargeFee"
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
							<div class='input-group date' id='oneTimeDate2'>
							<input id="activeTime" name="activeTime" type='text' value='<s:date name="#request.pobChargingPile.activeTime" format="yyyy/MM/dd" />'
