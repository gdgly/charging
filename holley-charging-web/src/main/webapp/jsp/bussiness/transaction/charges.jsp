...
<body>
		...
		<div class="container main-body tablePageSize">
			<div class="row tableSearchSize">
				<div class="col-sm-3">
					...
					<a class="hide" id="comeBack" onclick="comeback();" title="返回" href="javascript:;">
			...
			<div id="stationDiv">
				<div class="tableDivSize">
					<table class="table table-condensed" id="stationChaTable">
						<thead>
						</thead>
						<tbody>
						</tbody>
			...
			<div id="pileDiv" class="hide">
				<div class="tableDivSize">
					<table class="table table-condensed" id="pileChaTable">
						<tbody>
						</tbody>
					</table>
				</div>
	...
	<script src="res/js/bussiness/charging.js" type="text/javascript"></script>
</body>
</html>
