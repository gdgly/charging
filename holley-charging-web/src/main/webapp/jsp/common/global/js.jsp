...
<%-- <script src="<%=request.getContextPath()%>/res/js/common/jquery.easing.1.3.js" type="text/javascript"></script>
<script src="<%=request.getContextPath()%>/res/js/common/jquery.scrollify.min.js" type="text/javascript"></script> --%>
