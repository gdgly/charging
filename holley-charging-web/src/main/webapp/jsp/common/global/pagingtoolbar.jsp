...
<div class="text-right" id="pagingToolbar" style="padding-top:2%;padding-right: 20px;">
	<ul class="pagination">
  	  <li>
	...
	共  <span id="totalPage" style="color:#337ab7;"></span>  页,
	共  <span id="totalProperty" style="color:#337ab7;"></span>  条记录
	<ul class="pagination">
	  <li>
