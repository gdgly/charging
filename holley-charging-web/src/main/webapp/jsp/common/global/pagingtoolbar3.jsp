...
<div class="text-right" id="pagingToolbar3" style="padding-top:2%; padding-right: 20px;">
	<ul class="pagination">
  	  <li>
	...
	共  <span id="totalPage3" style="color:#337ab7;"></span>  页,
	共  <span id="totalProperty3" style="color:#337ab7;"></span>  条记录
	<ul class="pagination">
	  <li>
