...
<%@include file="../../common/global/bootStrapDateUtil.jsp"%>
	<section class="content-header">
      	<h1><s:if test="#request.webUser.usertype.value == 3">我的预约</s:if><s:else>预约记录</s:else></h1> 
	    <ol class="breadcrumb">
		     <li>
	        ...
	        <li class="active"> <s:if test="#request.webUser.usertype.value == 3">我的预约</s:if><s:else>预约记录</s:else></li>
	    </ol>
    </section>
    <!-- Main content -->
...
<script src="res/js/user/account/userAppointment.js"></script>
