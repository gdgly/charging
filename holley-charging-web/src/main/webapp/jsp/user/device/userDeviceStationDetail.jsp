        ...
        <div class="box box-info">
            <div class="box-header with-border">
              ...
              <s:if test="#request.validOrUnValid == 'valid'">
					 <button onclick="href('userDevice/initUserDevice.action');" type="button"
							class="btn btn-info btn-sm pull-right">返回</button>
					 </s:if>
					 <s:elseif test="#request.validOrUnValid == 'unValid'">
					 <button onclick="href('userDevice/initUserUnDevice.action');" type="button"
							class="btn btn-info btn-sm pull-right">返回</button>
					 </s:elseif>
            </div>
            <!-- /.box-header -->
