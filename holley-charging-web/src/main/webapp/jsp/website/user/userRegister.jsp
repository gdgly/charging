...
<head>
  ...
  <%@include file="../../common/global/meta.jsp"%>
    <link rel="stylesheet" href="res/css/website/userRegister.css" >
<style type="text/css">
</style>
</head>
...
<!--main-->
				...
				<div class="register-page box-shadow">
					<!--nav-tabs-->
					 <ul class="nav nav-tabs" role="tablist">
			          <li role="presentation" class="active"><a href="#" role="tab" data-toggle="tab" id="persionTab">个人注册</a></li>
			          <li role="presentation"><a href="#" role="tab" data-toggle="tab" id="enterpriseTab">运营商注册</a></li>
			        </ul>
					  <!--tab-content-->
					  <div style="padding-top: 50px;">
						  ...
						  <div class="regist-content">
						  	<form class="form-horizontal" id="registerForm" action="">
						        ...
						        <div class="form-group">
						            <label for="checkpassword" class="col-sm-2 control-label">再次确认</label>
						            <div class="col-sm-10">
								...
								<div class="form-group">
						            <div class="col-sm-offset-2 col-sm-10">
						                ...
						                <button type="button" class="btn btn-gray btn-lg" id="registerBtn" onclick="register();">提交</button>
						                <!-- 
  ...
  <script src="res/js/website/user/userRegister.js" type="text/javascript"></script>
</body>
</html>
