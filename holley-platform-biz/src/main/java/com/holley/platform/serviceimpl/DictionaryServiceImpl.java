...
import com.holley.platform.dao.sys.SysCarBrandMapper;
...
public class DictionaryServiceImpl implements DictionaryService {
    ...
    public List<SysCarBrand> selectCarBrandByExample(SysCarBrandExample example) {
        return this.sysCarBrandMapper.selectByExample(example);
    }
    ...
    public void setSysCarBrandMapper(SysCarBrandMapper sysCarBrandMapper) {
        this.sysCarBrandMapper = sysCarBrandMapper;
    }
